...
-- Tiempo de generación: 16-06-2025 a las 08:38:13
...
INSERT INTO `cliente` (`id_cliente`, `id_usuario`, `id_nutricionista`) VALUES
(11, 3, 1),
(12, 6, NULL);
...
INSERT INTO `nutricionista` (`id_nutricionista`, `id_usuario`) VALUES
(1, 1);
...
INSERT INTO `usuario` (`id_usuario`, `nombre`, `apellidos`, `email`, `contrasena_hash`, `tipo_usuario`, `fecha_registro`, `altura`, `peso`, `edad`, `sexo`, `actividad_fisica`, `objetivo`, `metabolismo_basal`) VALUES
(1, 'nutricionista', 'nutricionista', 'nutricion@nutricion.org', '$2y$10$BLaVB3Li.9AStWaWNKpw9uVqmyE4B5saMpTnD37DGM4TQDRDF8mMq', 'nutricionista', '2025-05-23 00:00:00', NULL, NULL, NULL, 'masculino', NULL, NULL, NULL),
(3, 'BASE2', 'BASE', 'BASE@base.org', '$2y$10$MhzocYAsyLI0xCu/lvo1o.Fs05.7Dm484OBroaffkS6Ff/xgX77.2', 'base', '2025-05-29 00:00:00', 33.00, 33.00, 33, 'masculino', 'sedentario', '33', 33.00),
(4, 'base2', 'base2', 'base2@base2.com', '$2y$10$jqY9nc60nSPOd9f/7HFH3uQ3DBn96zBwyLqpYqwZEXLaRgrw4ii.i', 'base', '2025-06-02 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(6, 'base3', 'base3', 'base3@base3.com', '$2y$10$ta26tSW2VlJGB7j2w9RbR.woLIirTH5dh6rrWzCgzA51pRuCzgZ46', 'base', '2025-06-16 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
--
ALTER TABLE `alimento`
  MODIFY `id_alimento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=126;
...
--
ALTER TABLE `nutricionista`
  MODIFY `id_nutricionista` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `registro_alimento`
--
ALTER TABLE `registro_alimento`
  MODIFY `id_registro_alimento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;
